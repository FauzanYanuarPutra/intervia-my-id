      ...
      {shift ? (
        <div className="p-4 sm:p-5">
          ...
          <label className="mt-4 block text-xs font-semibold text-portal-soft">
            ...
            <RupiahInput min={0} value={actualCash ? Number(actualCash) : null} onValueChange={value => setActualCash(value == null ? '' : String(value))} className={inputClass + ' text-base font-bold'} placeholder="Masukkan nominal" />
          </label>
        ...
        <div className="p-4 sm:p-5">
          <label className="block text-xs font-semibold text-portal-soft">
            Kas awal
            <RupiahInput min={0} value={openingCash ? Number(openingCash) : null} onValueChange={value => setOpeningCash(value == null ? '' : String(value))} className={inputClass + ' text-base font-bold'} placeholder="Masukkan nominal" />
          </label>
          <details className="group mt-3">
            <summary className="flex cursor-pointer list-none items-center gap-1 text-xs font-semibold text-portal-soft">
              Detail shift <ChevronDown className="h-3.5 w-3.5 transition group-open:rotate-180" />
