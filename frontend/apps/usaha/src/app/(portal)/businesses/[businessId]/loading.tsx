...
export default function BusinessLoading() {
  return (
    <main
      ...
      aria-busy="true"
      aria-label="Memuat halaman usaha"
    >
      <div className="mx-auto w-full max-w-[1120px] space-y-4">
        <section className="overflow-hidden rounded-[24px] border border-slate-200 bg-white">
          ...
          <div className="px-3 pb-4 sm:px-5 sm:pb-5">
            <div className="-mt-7 flex items-end gap-3 sm:-mt-9">
              <Pulse className="h-16 w-16 shrink-0 rounded-full ring-[4px] ring-white sm:h-20 sm:w-20" />
              <div className="min-w-0 flex-1 pb-1">
                <Pulse className="h-5 w-40 rounded-lg sm:h-6 sm:w-56" />
        ...
        <section className="rounded-[18px] border border-slate-200 bg-white p-4 sm:p-5">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <Pulse className="mt-2 h-3 w-full max-w-[560px] rounded-full" />
              <Pulse className="mt-2 h-3 w-3/4 max-w-[420px] rounded-full" />
            </div>
          </div>
        </section>
        ...
        <section className="rounded-[18px] border border-slate-200 bg-white p-4 sm:p-5">
          ...
          <div className="mt-4 space-y-2">
            {Array.from({ length: 5 }).map((_, index) => (
              <div key={index} className="flex min-h-14 items-center gap-3 border-b border-slate-100 last:border-b-0">
                <Pulse className="h-9 w-9 shrink-0 rounded-xl" />
                <div className="min-w-0 flex-1">
                  <Pulse className="h-3 w-40 rounded-full" />
                  <Pulse className="mt-2 h-2.5 w-28 rounded-full" />
                </div>
