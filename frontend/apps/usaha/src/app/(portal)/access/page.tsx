    ...
    >
      <div className="mx-auto max-w-5xl space-y-4">
        <PageHeader
          ...
          description="Terima undangan atau pilih usaha yang ingin kamu kelola."
        ...
        <section>
          <div className="mb-2.5"><h2 className="font-black text-portal-ink">Undangan masuk</h2><p className="mt-0.5 text-xs text-portal-soft">Pilih terima atau tolak. Tidak ada akses sebelum kamu menerima.</p></div>
          <div className="merchant-surface-bordered p-3 sm:p-4"><PendingOrganizationInvitations showEmpty /></div>
        </section>

        <section>
          <div className="mb-2.5"><h2 className="font-black text-portal-ink">Usaha yang bisa diakses</h2><p className="mt-0.5 text-xs text-portal-soft">Usaha milikmu dan usaha yang kamu ikuti.</p></div>
