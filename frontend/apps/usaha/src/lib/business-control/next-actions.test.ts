...
describe('buildMerchantNextActions', () => {
  ...
  it('only offers settlement reconciliation for enabled channels with durable unreconciled data', () => {
  ...
  it('offers channel pricing and first money entry only when durable state says they are needed', () => {
