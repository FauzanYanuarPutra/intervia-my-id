...
function buildCopy(isId: boolean) {
  return isId
    ? {
        ...
        refresh: 'Muat ulang',
        refreshing: 'Memuat...',
        profileReady: 'Lengkapi profil',
        profileHint:
          'Tambahkan info penting supaya orang lebih yakin menghubungi kamu.',
        ...
        quickActions: 'Mau melakukan apa?',
        createPost: 'Buat penawaran',
        managePosts: 'Kelola konten',
        manageListings: 'Produk & jasa saya',
        contentStudio: 'Kelola usaha',
        contentStudioHint:
          'Produk, jasa, komunitas, dan video.',
        openContentStudio: 'Kelola',
        ...
        noPostsDescription:
          'Buat produk atau jasa agar lebih mudah ditemukan.',
        makePost: 'Buat penawaran pertama',
        noDraftTitle: 'Belum ada yang masih diproses',
        noDraftDescription:
          'Draft, konten yang sedang dicek, atau yang perlu diperbaiki akan muncul di sini.',
        manageDrafts: 'Cek & edit yang belum tayang',
        photoProfile: 'Foto profil',
        bioBusiness: 'Tentang usaha atau keahlian',
        businessLocation: 'Lokasi usaha',
        contact: 'Kontak',
        businessPhoto: 'Foto sampul',
        ...
        profileFallback:
          'Ceritakan singkat tentang usaha atau keahlianmu.',
        locationFallback: 'Tambahkan lokasi',
    ...
    : {
        ...
        noDraftTitle: 'Nothing is waiting here',
        noDraftDescription:
          'Drafts, items under review, or items needing changes will appear here.',
        manageDrafts: 'Check & edit',
