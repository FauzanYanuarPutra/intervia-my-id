...
export const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    name: 'News',
    meta: {
      title: "Lajukan News | Ekonomi, Bisnis, dan UMKM",
      description: "Berita ekonomi, bisnis, UMKM, teknologi, regulasi, dan daerah dengan dampak praktis untuk pelaku usaha.",
      titleEn: "Lajukan News | Economy, Business, and SMEs",
      descriptionEn: "Economy, business, SME, technology, regulation, and local news with practical impact for business owners.",
      topbar: { isVisibleOnWeb: true, isVisibleOnMobile: true },
      navbar: { isVisibleOnWeb: true, isVisibleOnMobile: true },
      bottomNav: { isVisibleOnWeb: false, isVisibleOnMobile: false },
      footer: { isVisibleOnWeb: true, isVisibleOnMobile: true },
    ...
    children: [
      {
        ...
        meta: {
          title: "Kirim Berita",
          description: "Kirim berita atau analisis untuk ditinjau tim editorial Lajukan News.",
          titleEn: "Submit News",
          descriptionEn: "Submit news or analysis for Lajukan News editorial review.",
          navbar: { isVisibleOnWeb: true, isVisibleOnMobile: true },
          bottomNav: { isVisibleOnWeb: false, isVisibleOnMobile: false },
          footer: { isVisibleOnWeb: true, isVisibleOnMobile: true },
        },
      ...
      },
      {
        ...
        meta: {
          title: "Kiriman Berita Saya",
          description: "Pantau status review dan revisi kiriman berita.",
          titleEn: "My News Submissions",
          descriptionEn: "Track editorial review and revisions for your news submissions.",
          navbar: { isVisibleOnWeb: true, isVisibleOnMobile: true },
          bottomNav: { isVisibleOnWeb: false, isVisibleOnMobile: false },
          footer: { isVisibleOnWeb: true, isVisibleOnMobile: true },
        },
      ...
      {
        path: `${RoutePath.NEWS}/category/:category`,
        name: 'News Category',
        meta: {
          title: "Kategori Lajukan News",
          description: "Baca berita berdasarkan kategori.",
          titleEn: "Lajukan News Category",
          descriptionEn: "Read news by category.",
          navbar: { isVisibleOnWeb: true, isVisibleOnMobile: true },
          bottomNav: { isVisibleOnWeb: false, isVisibleOnMobile: false },
          footer: { isVisibleOnWeb: true, isVisibleOnMobile: true },
        },
      ...
      {
        path: `${RoutePath.NEWS}/topic/:topic`,
        name: 'News Topic',
        meta: {
          title: "Topik Lajukan News",
          description: "Baca berita berdasarkan topik.",
          titleEn: "Lajukan News Topic",
          descriptionEn: "Read news by topic.",
          navbar: { isVisibleOnWeb: true, isVisibleOnMobile: true },
          bottomNav: { isVisibleOnWeb: false, isVisibleOnMobile: false },
          footer: { isVisibleOnWeb: true, isVisibleOnMobile: true },
        },
      ...
      {
        path: `${RoutePath.NEWS}/location/:location`,
        name: 'News Location',
        meta: {
          title: "Berita Daerah",
          description: "Baca berita berdasarkan lokasi.",
          titleEn: "Local News",
          descriptionEn: "Read news by location.",
          navbar: { isVisibleOnWeb: true, isVisibleOnMobile: true },
          bottomNav: { isVisibleOnWeb: false, isVisibleOnMobile: false },
          footer: { isVisibleOnWeb: true, isVisibleOnMobile: true },
        },
      ...
      },
      {
        ...
        name: 'News Article',
        meta: {
          title: "Artikel Lajukan News",
          description: "Baca berita dan analisis dari Lajukan News.",
          titleEn: "Lajukan News Article",
          descriptionEn: "Read news and analysis from Lajukan News.",
          navbar: { isVisibleOnWeb: true, isVisibleOnMobile: true },
          bottomNav: { isVisibleOnWeb: false, isVisibleOnMobile: false },
          footer: { isVisibleOnWeb: true, isVisibleOnMobile: true },
        },
