                ...
                <div className={card}>
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button disabled={busy} onClick={() => void saveNews('edit')} className="rounded-xl bg-[color:var(--color-primary)] px-4 py-2 text-sm font-bold text-white disabled:opacity-50">Simpan</button>
