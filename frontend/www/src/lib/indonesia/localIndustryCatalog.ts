...
export const INDONESIA_LOCAL_INDUSTRY_PILLARS: IndonesiaIndustryPillar[] = [
  {
    ...
    href: '/explore?type=product&q=pangan%20lokal%20siap%20ekspor',
    examples: [
      'beras',
      'singkong',
      'sagu',
  ...
  },
  {
    ...
    href: '/explore?type=product&q=brand%20lokal%20fashion%20herbal%20ekspor',
...
export const LOCAL_FIRST_HOME_LINKS: LocalFirstHomeLink[] = [
  ...
  {
    href: '/explore?type=service&q=logistik%20ekspor%20umkm',
