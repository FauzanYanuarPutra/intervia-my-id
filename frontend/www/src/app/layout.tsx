...
export default async function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body className="app-cohesive-theme m-0 min-h-screen min-h-[100svh] w-full overflow-x-hidden bg-[color:var(--app-surface-muted)] p-0 font-sans text-[color:var(--app-text)] antialiased dark:bg-[color:var(--app-surface-strong)] dark:text-[color:var(--app-text-soft)]">
        <ScrollToTop />
        <AutoHideScrollbars />
