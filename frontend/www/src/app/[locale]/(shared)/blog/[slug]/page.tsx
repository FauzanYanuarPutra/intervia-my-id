  ...
  return (
    <main className="page-shell page-rhythm pb-12 pt-6">
      ...
      <nav aria-label="Breadcrumb" className="flex flex-wrap gap-2 text-sm">
        <Link
          href="/blog"
          className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 py-1.5 font-black text-slate-700 transition hover:border-emerald-200 hover:text-emerald-700 dark:border-white/10 dark:bg-slate-900 dark:text-slate-200"
        >
      ...
      <article className="overflow-hidden rounded-[34px] border border-emerald-100 bg-white shadow-[0_24px_68px_-50px_rgba(15,23,42,0.38)] dark:border-white/10 dark:bg-slate-900">
        <header className="bg-[linear-gradient(135deg,#fffdf6_0%,#effdf5_54%,#fff7ed_100%)] p-5 dark:bg-[linear-gradient(135deg,#0f172a_0%,#052e24_58%,#1c1917_100%)] sm:p-8 lg:p-10">
          ...
          <h1 className="mt-5 max-w-4xl text-3xl font-black tracking-[-0.06em] text-slate-950 dark:text-white sm:text-5xl">
          ...
          <div className="min-w-0">
            ...
            <section className="mt-8 rounded-[28px] border border-emerald-100 bg-emerald-50 p-5 dark:border-emerald-400/20 dark:bg-emerald-400/10 sm:p-6">
              ...
              <Link
                ...
                className="mt-4 inline-flex min-h-11 items-center gap-2 rounded-full bg-emerald-700 px-5 text-sm font-black text-white transition hover:bg-emerald-800"
              >
            ...
            <section className="rounded-[26px] border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/[0.04]">
              ...
              <div className="mt-3 flex flex-wrap gap-1.5">
                {article.keywords.slice(0, 6).map(keyword => (
                  <span
                    key={keyword}
                    className="rounded-full bg-white px-2.5 py-1 text-[11px] font-black text-slate-600 dark:bg-slate-950/42 dark:text-slate-300"
                  >
                    {keyword}
                  </span>
                ))}
            ...
            <section className="rounded-[26px] border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900">
              ...
              <div className="mt-3 grid gap-2">
                {related.map(item => (
                  ...
                  >
                    <span className="block text-sm font-black leading-5 text-slate-900 group-hover:text-emerald-800 dark:text-white dark:group-hover:text-emerald-200">
