...
VALUES
    (gen_random_uuid(), 'admin', 'Platform admin role alias', TRUE, 'global'),
    (gen_random_uuid(), 'content_admin', 'CMS content administrator', TRUE, 'global'),
...
WHERE lower(u.email) = 'admin@lajukan.com'
...
WHERE lower(u.email) = 'agent@lajukan.com'
ON CONFLICT DO NOTHING;
