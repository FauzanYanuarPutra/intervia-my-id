ALTER TABLE lajukan_forum_threads
  ADD COLUMN IF NOT EXISTS group_id text NULL REFERENCES lajukan_groups(id) ON DELETE SET NULL;

CREATE INDEX IF NOT EXISTS lajukan_forum_threads_group_idx
  ON lajukan_forum_threads (group_id, last_activity_at DESC);
