...
for path, warning_threshold, hard_ceiling in (
    ("frontend/apps/www/src/app/[locale]/(shared)/reels/ReelsClient.tsx", 300_000, 326_000),
    ("frontend/apps/www/src/components/community/CommunityFeedClient.tsx", 230_000, 248_000),
):
    target = ROOT / path
    if not target.is_file():
        continue
...
for path, source, main_source, required_markers, forbidden_markers in (
    ...
    (
        "services/marketplace_service/src/content_projection.rs",
        marketplace_content_projection_source,
        marketplace_source,
        (
        ...
        (
            "fn project_content_response_metadata",
            "fn project_public_reference_metadata",
        ),
    ),
    (
        "services/community_service/src/media.rs",
        community_media_source,
        community_main_source,
        (
        ...
        (
            "fn upload_dir",
            "fn has_valid_media_signature",
            "fn first_feed_media_url",
        ),
    ),
):
