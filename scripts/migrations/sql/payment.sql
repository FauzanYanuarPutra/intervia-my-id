...
INSERT INTO transactions SELECT id,content_id,buyer_id,seller_id,amount_cents,currency,transaction_status,offer_message,response_message,deal_kind,fulfillment_mode,transaction_meta,created_at,updated_at FROM legacy.transactions ON CONFLICT(id) DO NOTHING;
...
IMPORT FOREIGN SCHEMA public LIMIT TO (transaction_disputes) FROM SERVER legacy_marketplace INTO legacy;
INSERT INTO transaction_disputes SELECT * FROM legacy.transaction_disputes ON CONFLICT(id) DO NOTHING;
