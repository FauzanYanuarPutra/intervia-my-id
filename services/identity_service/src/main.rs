...
use identity_service::routes::{
    ...
    get_user_by_email, get_user_by_phone, get_user_detail, health_check,
    list_backoffice_google_access, list_users, login, login_phone, logout, me, oauth_google,
    ready_check, refresh_token, register, reset_password, service_metrics, update_me_profile,
