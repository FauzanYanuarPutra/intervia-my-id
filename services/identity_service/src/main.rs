...
use identity_service::routes::{
    ...
    list_users, login, login_phone, logout, me, moderate_user, oauth_google, ready_check,
    refresh_token, register, reset_password, respond_backoffice_invitation,
    revoke_backoffice_invitation, search_backoffice_candidates, service_metrics,
    transition_privacy_request, transition_security_incident, update_me_profile,
    upsert_backoffice_google_access, list_privacy_requests, list_security_incidents,
};
