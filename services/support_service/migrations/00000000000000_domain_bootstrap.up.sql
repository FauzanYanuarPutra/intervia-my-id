...
VALUES ('support_service','domain-bootstrap-v1')
...
CREATE INDEX IF NOT EXISTS idx_support_tickets_support_room_id ON support_tickets(support_room_id);
...
CREATE INDEX IF NOT EXISTS idx_support_ticket_replies_ticket_id_created_at ON support_ticket_replies(ticket_id,created_at DESC);
